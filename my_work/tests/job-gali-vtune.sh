...
#SBATCH --account=ICT24_MHPC_1           #Sis25_baroni    # account number
...
export PW=/g100_work/ICT24_MHPC_1/gparedes/q-e/build/bin/pw.x
export D3H=/g100_work/ICT24_MHPC_1/gparedes/q-e/build/bin/d3hess.x 
export PH=/g100_work/ICT24_MHPC_1/gparedes/q-e/build/bin/ph.x
